...
- **_소유자** - 토큰 ID에서 NFT 소유자로의 매핑
- **_balances** - 소유자가 소유한 NFT 수량에 대한 매핑
- **_승인** - 토큰 ID에서 해당 NFT를 전송하도록 승인된 계정으로의 매핑
- **_approvealls** - 소유자부터 모든 NFT를 이전하도록 승인된 계정으로의 매핑
